  ...
  return(
    <div className="bg-[url('./assets/images/bg-mobile-light.jpg')] bg-no-repeat bg-contain bg-gray-300 min-h-screen">
      ...
      <main className="container mx-auto px-4 mt-8 ">
        ...
        <article className="border-b flex gap-4 border-b-gray-400 ">
          <button className="rounded-full border-b-2 h-5 w-5 inline-block flex-none"></button>
          <p className="text-gray-600 grow">Comlete online Javascript curse in Udemy</p>
